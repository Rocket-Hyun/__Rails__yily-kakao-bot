...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { desc: @drink.desc, drink_img: @drink.drink_img, name: @drink.name } }, as: :json
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { desc: @drink.desc, drink_img: @drink.drink_img, name: @drink.name } }, as: :json
    assert_response 200
  end
